...
@section('content')
                ...
                <div class="flex grid grid-cols-2 gap-3">
                    <div class="">
                        ...
                        <div class="bg-gray-100 p-6 rounded-lg shadow-inner space-y-4 mb-6">
                            <div class="bg-white p-4 rounded shadow">
                                ...
                                <p class="text-gray-700">Great tips on learning Laravel! Very helpful.</p>
                            </div>
                    ...
                    <div class="">
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            <h2 class="text-2xl font-semibold mb-4">📬 Subscribe for Updates</h2>
                            <p class="text-gray-600 mb-4">Stay updated with our latest blog posts. No spam, we promise!</p>
    ...
    <section class="">
        ...
        <div class="flex-wrap grid grid-cols-2 gap-3">
            <div class="rounded-lg shadow-md p-6 mb-6 hover:shadow-xl transition-shadow duration-300">
