            ...
            <div class="mx-auto max-w-7xl font-quicksand py-4">
                <div class="p-8 bg-slate-100 rounded-3xl shadow-boxshadow hover:shadow-boxshadow2 transition-all duration-300">
                    <div class="flex justify-center  mb-4 gap-3 flex-wrap">
                        <button onclick="filterByCategory('all')" class="category-btn group py-2 shadow-lg border-b-cyan-600 border-b-2 px-2 cursor-pointer transition-all duration-300 rounded hover:bg-cyan-600">
                            <span class="text-16 text-cyan-600 font-semibold group-hover:text-white transition-all duration-300 capitalize">
                                all
                            </span>
                        </button>
                        <button onclick="filterByCategory('electronics')" class="category-btn group py-2 shadow-lg border-b-cyan-600 border-b-2 px-2 cursor-pointer transition-all duration-300 rounded hover:bg-cyan-600">
                            <span class="text-16 text-cyan-600 font-semibold group-hover:text-white transition-all duration-300 capitalize">
                                electronics
                            </span>
                        </button>
                        <button onclick="filterByCategory('gadget')" class="category-btn group py-2 shadow-lg border-b-cyan-600 border-b-2 px-2 cursor-pointer transition-all duration-300 rounded hover:bg-cyan-600">
                            <span class="text-16 text-cyan-600 font-semibold group-hover:text-white transition-all duration-300 capitalize">
                                gadget
                            </span>
                        </button>
                        <button onclick="filterByCategory('home')" class="category-btn group py-2 shadow-lg border-b-cyan-600 border-b-2 px-2 cursor-pointer transition-all duration-300 rounded hover:bg-cyan-600">
                            <span class="text-16 text-cyan-600 font-semibold group-hover:text-white transition-all duration-300 capitalize">
                                Home
                        </button>
                        <button onclick="filterByCategory('kitchen')" class="category-btn group py-2 shadow-lg border-b-cyan-600 border-b-2 px-2 cursor-pointer transition-all duration-300 rounded hover:bg-cyan-600">
                            <span class="text-16 text-cyan-600 font-semibold group-hover:text-white transition-all duration-300">
                                kitchen
                            </span>
                        </button>
                        <button onclick="filterByCategory('travel')" class="category-btn group py-2 shadow-lg border-b-cyan-600 border-b-2 px-2 cursor-pointer transition-all duration-300 rounded hover:bg-cyan-600">
                            <span class="text-16 text-cyan-600 font-semibold group-hover:text-white transition-all duration-300">
                                travel
                            </span>
                        </button>
                        <button onclick="filterByCategory('fashion')" class="category-btn group py-2 shadow-lg border-b-cyan-600 border-b-2 px-2 cursor-pointer transition-all duration-300 rounded hover:bg-cyan-600">
                            <span class="text-16 text-cyan-600 font-semibold group-hover:text-white transition-all duration-300">
                                fashion
                            </span>
                        </button>
                    ...
                    <div class="flex justify-center  mt-8 ">
                        <button id="prev-btn" class=" group py-2 shadow-lg border-b-cyan-600 border-b-2 px-2 cursor-pointer transition-all duration-300 rounded hover:bg-cyan-600">
                            <span class="text-16 text-cyan-600 font-semibold group-hover:text-white transition-all duration-300">
                                Prevew
                            </span>
                        </button>
                        <span id="page-indicator" class="text-16 text-cyan-600 font-semibold group-hover:text-white transition-all duration-300 py-2 px-4">
                            page: 1
                        </span>
                        <button id="next-btn" class=" group py-2 shadow-lg border-b-cyan-600 border-b-2 px-2 cursor-pointer transition-all duration-300 rounded hover:bg-cyan-600">
                            <span class="text-16 text-cyan-600 font-semibold group-hover:text-white transition-all duration-300">
                                Next
                            </span>
                        </button>
